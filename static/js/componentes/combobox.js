...
const Combobox = class {
  ...
  constructor(config) {
    ...
    this.opcionesSeleccionadas = config.opcionesSeleccionadas || new Set();
    this.seleccionada = config.seleccionada || null;
    this.name = config.name;
    this.valorErroneoIntroducido = config.valorErroneoIntroducido || false;
    /** @type { number | null } */
    this.ultimoValorIncorrecto = null;
    /** @type { HTMLInputElement | null } **/
    this.ultimaSeleccionada = null;
    /** @type { boolean } */
    this.shiftPresionado = false;
    this.q = "";
    this.mostrarCantidad = config.mostrarCantidad || false;
    this.cantidadFiltradas = config.opciones?.length || 0;
  }
  ...
  destacarPrimeraCoincidencia(teclaPresionada) {
